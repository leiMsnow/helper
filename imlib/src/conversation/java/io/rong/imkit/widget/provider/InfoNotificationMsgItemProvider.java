 ...
 */
@ProviderTag(messageContent = InformationNotificationMessage.class, showPortrait = false, showProgress = false, showWarning = false, centerInHorizontal = true,
...
public class InfoNotificationMsgItemProvider extends IContainerItemProvider.MessageProvider<InformationNotificationMessage> {
    ...
    @Override
    public void bindView(View v, int position, InformationNotificationMessage content, Message message) {
    ...
    @Override
    public void onItemLongClick(View view, int position, InformationNotificationMessage content, final Message message) {
        String name = null;
    ...
    public View newView(Context context, ViewGroup group) {
        ...
        viewHolder.contentTextView.setAutoLinkMask(Linkify.ALL);
