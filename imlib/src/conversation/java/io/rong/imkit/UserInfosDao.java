...
public class UserInfosDao extends AbstractDao<UserInfos, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Userid = new Property(1, String.class, "userid", false, "USERID",TABLENAME);
        public final static Property Username = new Property(2, String.class, "username", false, "USERNAME",TABLENAME);
        public final static Property Portrait = new Property(3, String.class, "portrait", false, "PORTRAIT",TABLENAME);
        public final static Property Status = new Property(4, String.class, "status", false, "STATUS",TABLENAME);
    };
