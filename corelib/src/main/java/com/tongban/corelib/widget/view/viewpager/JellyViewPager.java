package com.tongban.corelib.widget.view.viewpager;
...
import com.tongban.corelib.widget.view.viewpager.util.SpringSystem;
...
public class JellyViewPager extends ViewPager {
	...
	private void init(Context context) {
		super.addOnPageChangeListener(new MyPageChageListener());
